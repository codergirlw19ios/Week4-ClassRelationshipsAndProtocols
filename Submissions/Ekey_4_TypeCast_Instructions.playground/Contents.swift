...
print(type(of: children))   // children is an array of human
...
if let child = children.first {
    // child is a human type
    child is Child
    child is Adult   // false
    child is Human
    
    // type checking is "Is" statement
    // type casting is or "downcasting" is AS statement
