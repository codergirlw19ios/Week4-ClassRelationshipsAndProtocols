...
class Adult: Human {
    ...
    func adoptDog() -> Dog {
        ...
        // dog is a mammal and pet, not a human  self wants an array of humans -- moved to mammel and changed array...  ( maybe dependancy injection could have been used here.. )
        self[.pet] = [dog]
        return dog
