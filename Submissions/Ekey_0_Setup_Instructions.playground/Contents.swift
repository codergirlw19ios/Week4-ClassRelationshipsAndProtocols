...
enum ConsumptionClasification {
    case omnivore, carnivore, herbivore
    
//    func canEat(food: Food) -> Bool {
//        if (self == food.consumptionType)
//        {
//            return true
//        }
//        else if (self == .omnivore)
//        {
//            return true
//        }
//        else
...
//    }
    ...
    func canEat(food: Food) -> Bool {
        return self == .omnivore ? true : self == food.consumptionType
    }
...
enum Food {
    ...
    var consumptionType: ConsumptionClasification {
        switch self {
