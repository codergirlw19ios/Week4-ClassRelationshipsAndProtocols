...
class Mammal
{
    ...
    func Consume(food: Food){
        /*var newHealthVariable: Health?
        if ConsumptionClassification.canEat(food: food)
        {
            newHealthVariable = health.increasedHealth
        }
        else
        {
            newHealthVariable = health.decreasedHealth
            
        }*/
        guard let newHealthVariable = ConsumptionClassification.canEat(food: food) ? health.increasedHealth : health.decreasedHealth
            else
        {
            return
        }
        health = newHealthVariable
    }
...
class Human: Mammal
{
    ...
    override func Consume(food: Food) {
        guard let newHealthVariable = ConsumptionClassification.canEat(food: food) && !allergies.contains(food) ? health.increasedHealth : health.decreasedHealth
            else
        {
            return
        }
...
class Child: Human{
    ...
    override func Consume(food: Food) {
        guard !dislikedFoods.contains(food)
            else
        {
            print("NO!")
            return
